...
public class ActionServiceManager {
    ...
    public synchronized void setActionContribution(IActionContribution actionContribution) {
        waitUntilInitialized();
        System.out.println("ActionServiceManager.addingService(): " + actionContribution);
    ...
    public synchronized void unsetActionContribution(IActionContribution actionContribution) {
        List<Action> actions = actionContribution.getActions(application);
        ...
        for (Action action : actions) {
            ...
            for (Component component : components) {
                if (component instanceof JButton && action == ((JButton) component).getAction()) {
            ...
            for (Component component : components) {
                if (component instanceof JMenuItem && action == ((JMenuItem) component).getAction()) {
    ...
    public synchronized void initialize(Application application, JToolBar toolBar, JMenuBar menuBar) {
