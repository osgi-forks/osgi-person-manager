...
public class TreeView implements IViewContribution, IPersonListener {
    ...
    public TreeView() {
        super();
        icon = new ImageIcon(this.getClass().getResource("/icons/folder_user.png"));
        ...
        ImageIcon folderIcon = new ImageIcon(this.getClass().getResource("/icons/folder_user.png"));
        ImageIcon leafIcon = new ImageIcon(this.getClass().getResource("/icons/user_gray.png"));
        if (leafIcon != null) {
    ...
    public synchronized void removePersonManager(IPersonManager personManager, Map properties) {
        System.out.println("TreeView (DM): removePersonManager");
    ...
    @SuppressWarnings("unchecked")
    public synchronized void setPersonManager(IPersonManager personManager, Map properties) {
        System.out.println("TreeView (DM): setPersonManager");
